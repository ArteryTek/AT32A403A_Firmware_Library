...
int main(void)
{
   ...
   *  the timxclk is fixed to 200 mhz, the tmr2 counter clock is 200 mhz.
   ...
   * the timxclk is fixed to 200 mhz, the tmr2 counter clock is 200 mhz.
    ...
    tmr3 is running at 50 khz,
    and tmr4 is running at 2.5 khz */

  tmr_base_init(TMR2, 199, 0);
  tmr_cnt_dir_set(TMR2, TMR_COUNT_UP);

  tmr_base_init(TMR3, 19, 0);
  tmr_cnt_dir_set(TMR3, TMR_COUNT_UP);

  tmr_base_init(TMR4, 19, 0);
  ...
  tmr_channel_value_set(TMR2, TMR_SELECT_CHANNEL_1, 49);
