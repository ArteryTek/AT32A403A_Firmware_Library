...
int main(void)
{
  ...
  tmr2 pwm frequency = 200000000(systemclock)/200(period+1)/1000(div+1) = 1 khz
  tmr3 pwm frequency = 1000(tmr2 pwm frequency)/200(period+1)/1(div+1) = 5 hz */

  /* tmr2 and tmr3 counter mode configuration */
  tmr_base_init(TMR2, 199, 999);
