...
#ifndef __AT32A403A_BOARD_H
#define __AT32A403A_BOARD_H
...
/**
  ...
  * 1. at-start-a403a v1.x board
  * if define AT_START_A403A_V1, the header file support at-start-a403a v1.x board
  */

#if !defined (AT_START_A403A_V1)
#error "please select first the board at-start device used in your application (in at32a403a_board.h file)"
#endif
